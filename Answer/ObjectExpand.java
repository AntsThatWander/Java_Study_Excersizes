...
class Red extends Ingredient{
	...
	public Red(int quantity) {
		super(quantity);
	}
	
	@Override
	public int getResource() {
		return quantMult(RED_VALUE);
	}
...
class Blue extends Ingredient implements Processable{
	...
	public Blue(int quantity) {
		super(quantity);
	}
	
	@Override
	public int getResource() {
		return quantMult(BLUE_VALUE);
	}
	
	@Override
	public int getProcess() {
		return getResource() * (Processable.isEnough(quantity) ? 10 : 1);
	}
}
...
class Green extends Ingredient implements Processable{
	...
	public Green(int quantity) {
		super(quantity);
	}
	
	@Override
	public int getResource() {
		return quantMult(GREEN_VALUE);
	}
	
	@Override
	public int getProcess() {
		return getResource() * (Processable.isEnough(quantity) ? 15 : 1);
	}
